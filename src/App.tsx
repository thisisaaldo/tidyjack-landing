    ...
    <div className="font-sans min-h-screen">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-8 sm:py-12 md:py-16 reveal">
        ...
        <section id="areas" className="py-10 border-t border-black/10 reveal">
          <h2 className="font-display text-2xl font-semibold mb-3 bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Service Area</h2>
          <div className="flex justify-center reveal-children">
            <div className="card p-6 flex flex-col items-center text-center hover:bg-black/[.03] transition-colors max-w-xs">
              <div className="w-24 h-24 rounded-full border border-black/20 flex items-center justify-center bg-white text-black mb-3">
                <span className="font-semibold tracking-wide text-sm">AUS</span>
              </div>
              <div className="font-medium text-lg">Australian Destination</div>
              <div className="text-sm text-black/60">Nationwide Service</div>
            </div>
          </div>
        </section>
